            ...
            <nav class="bg-gray-800">
                            ...
                            <div class="ml-4 flex items-center md:ml-6">
                                ...
                                @auth
                                    ...
                                    <form method="POST" action="/logout">
                                        @csrf
                                        <x-form-button class="ml-4">Logout</x-form-button>
                ...
                <div class="md:hidden" id="mobile-menu">
                    <div class="space-y-1 px-2 pt-2 pb-3 sm:px-3">
                        ...
                        <a href="/about"
                            class="block rounded-md px-3 py-2 text-base font-medium text-gray-300 hover:bg-gray-700 hover:text-white">absolute</a>
                        <a href="/contact"
                    ...
                    <div class="border-t border-gray-700 pt-4 pb-3">
                        <div class="flex items-center px-5">
                            ...
                            <div class="ml-3">
                                <div class="text-base/5 font-medium text-white">Alireza Dej</div>
                                <div class="text-sm font-medium text-gray-400">alirezadejparvar@gmail.com</div>
                            </div>
                            <button type="button"
